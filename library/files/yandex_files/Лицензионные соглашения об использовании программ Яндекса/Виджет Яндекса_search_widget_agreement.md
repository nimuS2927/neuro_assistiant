 Лицензионное соглашение на использование программы «Виджет Яндекса» для мобильных устройств
===========================================================================================
...
-------------------
 ...
 1\.1\. Настоящее Лицензионное соглашение («Лицензия») устанавливает условия использования программы «Виджет Яндекса» для мобильных устройств («Программа») и заключено между любым лицом, использующим Программу («Пользователь»), и ООО «ЯНДЕКС», Россия, 119021, г. Москва, ул. Льва Толстого, 16, являющимся правообладателем исключительного права на Программу («Правообладатель»).
...
---------------
 ...
 4\.4\. Программа должна использоваться (в том числе распространяться) под наименованием: «Виджет Яндекса». Пользователь не вправе изменять наименование Программы, изменять и/или удалять знак охраны авторского права (copyright notice) или иное указание на Правообладателя.
...
-----------------------------------------------------
 ...
 5\.2\. Программа предоставляет Пользователю возможность использования функции голосового помощника для осуществления поисковых запросов путем голосового набора, получения краткой информации (быстрого ответа) по определенным запросам и информации из Сервисов Яндекса. Ответы голосового помощника формируются автоматически путем индексирования общедоступной информации. Ответы голосового помощника, не связанные с осуществлением поискового запроса (шуточные ответы) формируются на автоматической основе. В связи с этим Правообладатель не несет ответственности за точность, релевантность, корректность информации, полученной Пользователем посредством данной функции.

 5\.3\. Пользователь настоящим уведомлен и соглашается, что с момента включения им в Программе функции сбора статистики и до момента отключения им функции сбора статистики, Программа сможет собирать, хранить и передавать Правообладателю следующие данные: для версии Программы для операционной системы Android \- информацию об исполняемых на устройстве Пользователя приложениях, о месте нахождения устройства Пользователя, о состоянии подключений по сетям связи, о динамике энергопотребления, об установке и удалении приложений и об использовании функций Программы.

 5\.4\. Пользователь может в любой момент отказаться от сбора, хранения и передачи данных, указанных в п. 5\.3, отключив соответствующую функцию в настройках Устройства Пользователя.
...
-------------------------------
 ...
 6\.4\. ВВсе вопросы и претензии, связанные с использованием/невозможностью использования Программы, а также возможным нарушением Программой законодательства и/или прав третьих лиц, должны направляться через форму обратной связи по адресу [http://mobile\-feedback.yandex.ru/?from\=m\-yandex](http://mobile-feedback.yandex.ru/?from=m-yandex).
...
-------------------------------------------------------------------------
 ...
 7\.2\. В состав Программы в качестве отдельных ее компонентов входит стороннее программное обеспечение. Актуальная информация о таком стороннем программном обеспечении в составе Программы доступна по адресу: [https://yandex.ru/legal/search\_widget\_agreement/components](https://yandex.ru/legal/search_widget_agreement/components/). 

  8\. Изменения условий настоящей Лицензии
----------------------------------------

 8\.1\. Настоящее лицензионное соглашение может изменяться Правообладателем в одностороннем порядке. Уведомление Пользователя о внесенных изменениях в условия настоящей Лицензии публикуется на странице: [https://yandex.ru/legal/search\_widget\_agreement](/legal/search_widget_agreement/index.html). Указанные изменения в условиях лицензионного соглашения вступают в силу с даты их публикации, если иное не оговорено в соответствующей публикации.

  

 \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_

 *Дата публикации: 20\.06\.2017 г.*
